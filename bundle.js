...
var app = (function () {
  ...
  to {
    ...
    function create_fragment$7(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			attr_dev(div, "class", "auth svelte-13dot62");
    ...
    function create_fragment$2(ctx) {
    	...
    	const block = {
    		c: function create() {
    			...
    			add_location(h1, file$2, 8, 4, 230);
    			add_location(br0, file$2, 11, 8, 338);
    			add_location(br1, file$2, 11, 13, 343);
    			add_location(br2, file$2, 13, 8, 392);
    			add_location(br3, file$2, 13, 13, 397);
    			attr_dev(p, "class", "text svelte-149eylp");
    			add_location(p, file$2, 9, 4, 269);
    			attr_dev(section, "class", "content svelte-149eylp");
    			add_location(section, file$2, 7, 0, 200);
    		},
    		l: function claim(nodes) {
    			throw new Error("options.hydrate only works if the component was compiled with the `hydratable: true` option");
    		},
    ...
    function instance$2($$self, $$props, $$invalidate) {
    	...
    	$$self.$capture_state = () => ({ Timer, Links, Auth, start });
    	return [start];
    }
